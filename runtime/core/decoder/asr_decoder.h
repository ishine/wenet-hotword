...
struct DecodeResult {
  ...
  std::vector<std::string> corrected_hotwords; 
...
class AsrDecoder {
 ...
 private:
  ...
  bool TextToIds(const std::string& text, const std::vector<WordPiece> word_pieces, std::vector<int>* ids);
